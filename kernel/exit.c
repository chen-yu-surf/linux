...
{
	struct sched_cache_group *grp = current->sched_cache_grp;
...
static void exit_mm(void)
{
	...
	if (current->sched_cache_grp) {
		sched_cache_group_put(current->sched_cache_grp);
		current->sched_cache_grp = NULL;
	}
#endif
