...
/*
 * arg2: subcommand, arg3: destination pid (0 = self),
 * arg4: cookie out ptr for GET, source pid for SHARE_FROM (0 = self), else 0
 * arg5: pid type, the scope of the destination
 *
 * SHARE_FROM copies the group of arg4 to arg3, destination first as in
 * copy_from_user().
 */
		      ...
		      unsigned long arg4, unsigned long arg5)
{
	...
	if (arg2 == PR_SCHED_CACHE_SHARE_FROM) {
		if ((long)arg4 < 0)
			return -EINVAL;
	} else if (arg2 != PR_SCHED_CACHE_GET && arg4) {
