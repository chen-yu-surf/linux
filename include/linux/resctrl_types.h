...
enum resctrl_event_id {
	...
	PMT_EVENT_PCNT,
	PMT_EVENT_TOPDOWN_SLOTS,
	PMT_EVENT_FE_BOUND_SLOTS,
	PMT_EVENT_BACKEND_BOUND_SLOTS,
	PMT_EVENT_UOPS_RETIRED_HEAVY,
	PMT_EVENT_BR_MISPREDICT_SLOTS,
	PMT_EVENT_FE_BOUND_SLOTS_LATENCY,
	PMT_EVENT_MEMORY_BOUND_SLOTS,
	PMT_EVENT_RESERVED,
	PMT_EVENT_BOUND_ON_STORES,
	PMT_EVENT_MEMORY_STALLS_L1,
	PMT_EVENT_MEMORY_STALLS_L2,
	PMT_EVENT_MEMORY_STALLS_L3,
	PMT_EVENT_MEMORY_STALLS_MEM,
	PMT_EVENT_MEM_LOAD_RETIRED_L3_MISS,
	PMT_EVENT_MEM_LOAD_RETIRED_L4_MISS,
...
#define QOS_NUM_L3_RMBM_EVENTS    (QOS_L3_MBM_R3_EVENT_ID - QOS_L3_MBM_R0_EVENT_ID + 1)
...
#define QOS_NUM_L3_MBA_REGIONS (RDT_RESOURCE_MBA_R3 - RDT_RESOURCE_MBA_R0 + 1)
#define MBA_REGION_IDX(rid)    ((rid) - RDT_RESOURCE_MBA_R0)

#define RESOURCE_IS_MBA_REGION(rid) ((rid) >= RDT_RESOURCE_MBA_R0 && (rid) <= RDT_RESOURCE_MBA_R3)
