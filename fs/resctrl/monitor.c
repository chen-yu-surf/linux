...
struct mon_evt mon_event_all[QOS_NUM_EVENTS] = {
	...
	MON_EVENT(PMT_EVENT_TOPDOWN_SLOTS,		"topdown_slots",		RDT_RESOURCE_PERF_PKG,	false),
	MON_EVENT(PMT_EVENT_FE_BOUND_SLOTS,		"fe_bound_slots",		RDT_RESOURCE_PERF_PKG,	false),
	MON_EVENT(PMT_EVENT_BACKEND_BOUND_SLOTS,	"backend_bound_slots",		RDT_RESOURCE_PERF_PKG,	false),
	MON_EVENT(PMT_EVENT_UOPS_RETIRED_HEAVY,		"uops_retired_heavy",		RDT_RESOURCE_PERF_PKG,	false),
	MON_EVENT(PMT_EVENT_BR_MISPREDICT_SLOTS,	"br_mispredict_slots",		RDT_RESOURCE_PERF_PKG,	false),
	MON_EVENT(PMT_EVENT_FE_BOUND_SLOTS_LATENCY,	"fe_bound_slots_latency",	RDT_RESOURCE_PERF_PKG,	false),
	MON_EVENT(PMT_EVENT_MEMORY_BOUND_SLOTS,		"memory_bound_slots",		RDT_RESOURCE_PERF_PKG,	false),
	MON_EVENT(PMT_EVENT_RESERVED,			"reserved",			RDT_RESOURCE_PERF_PKG,	false),
	MON_EVENT(PMT_EVENT_BOUND_ON_STORES,		"bound_on_stores",		RDT_RESOURCE_PERF_PKG,	false),
	MON_EVENT(PMT_EVENT_MEMORY_STALLS_L1,		"memory_stalls_l1",		RDT_RESOURCE_PERF_PKG,	false),
	MON_EVENT(PMT_EVENT_MEMORY_STALLS_L2,		"memory_stalls_l2",		RDT_RESOURCE_PERF_PKG,	false),
	MON_EVENT(PMT_EVENT_MEMORY_STALLS_L3,		"memory_stalls_l3",		RDT_RESOURCE_PERF_PKG,	false),
	MON_EVENT(PMT_EVENT_MEMORY_STALLS_MEM,		"memory_stalls_mem",		RDT_RESOURCE_PERF_PKG,	false),
	MON_EVENT(PMT_EVENT_MEM_LOAD_RETIRED_L3_MISS,	"mem_load_retired_l3_miss",	RDT_RESOURCE_PERF_PKG,	false),
	MON_EVENT(PMT_EVENT_MEM_LOAD_RETIRED_L4_MISS,	"mem_load_retired_l4_miss",	RDT_RESOURCE_PERF_PKG,	false),
};
