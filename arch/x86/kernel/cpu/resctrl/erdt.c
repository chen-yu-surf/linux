 ...
 *
 * Return: L3 occupancy value (scaled), or 0 if no data is read.
 */
 ...
 *
 * Return: Monitoring data value (e.g. occupancy in bytes), or 0
 *         if no data is read.
 */
u64 erdt_mon_read(struct rdt_domain_hdr *hdr, int ev_id, int rmid)
{
