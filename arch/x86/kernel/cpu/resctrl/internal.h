...
/*
 * Control types of a region aware MBA controller. The values are the "type"
 * argument of resctrl_ctrl_name_region() and so match the order of the
 * RESCTRL_CTRL_NAME_REGION<n>_* enumerators.
 */
